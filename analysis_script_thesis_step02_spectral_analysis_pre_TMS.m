...
for isub=1:numel(subjects)
    ...
    save([datapath, filesep, subjects{isub}, filesep, 'data_', subjects{isub}, '_', 'all_ses', '_TMS_clean_demean'], 'data_tms_clean', '-v7.3')
    ...
    for icond = 1:numel(conditions)
        ...
        figure; ft_topoplotTFR(cfg,TFRhann5{icond}); colorbar
        title(['topoplot before TMS pulse, condition: ' conditions{icond}])
    end 
end 
